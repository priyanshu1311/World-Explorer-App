...
public class userControllerTest {
	...
	public void setUp() throws Exception {
		user = new User("mohsin@gmail.com", "Mohsin", "Mohsin", null, "male", "0987654321", "www.images.com");
	}
	...
	public void testGetUserFailure() throws Exception {
		...
		mockMvc.perform(get("/user/findUserByEmail/rajj@gmail.com")).andExpect(status().isConflict())
				.andDo(print());
